...
namespace AFT.Automation.Template.Model.Template1
{
    public partial class Elements
    {
        ...
        [FindsBy(How = How.CssSelector, Using = FooterLinksAttribute.FooterPromotionsLinkAttr)]        
        public IWebElement FooterPromotionsLink { get; set; }
        ...
        [FindsBy(How = How.CssSelector, Using = FooterLinksAttribute.FooterAgeRestrictionIconLinkAttr)]        
        public IWebElement FooterAgeRestrictionIconLink { get; set; }

        [FindsBy(How = How.CssSelector, Using = FooterLinksAttribute.FooterSafeAndSecureIconLinkAttr)]        
        public IWebElement FooterSafeAndSecureIconLink { get; set; }
        ...
        [FindsBy(How = How.CssSelector, Using = FooterLinksAttribute.FooterSiteIconLinkAttr)]        
        public IWebElement FooterSiteIconLink { get; set; }
    }
}
