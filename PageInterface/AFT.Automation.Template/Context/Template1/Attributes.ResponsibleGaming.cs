namespace AFT.Automation.Template.Context.Template1
{
    ...
    {
        /// <summary>
        /// Template 1 Responsible Gaming page attributes
        /// </summary>
        protected static class ResponsibleGamingAttribute
        {
            ...
            public const string RealityCheckArrowAttr = "#reality-check > div.form__body > div > div.col-md-4.self-exclude.reality-sb > span > span.selection > span > span.select2-selection__arrow";
            ...
            public const string RealityCheckSaveBtnAttr = "#reality-check > div.form__body > div > div.col-md-5 > input";
            ...
            public const string TimeOutArrowAttr = "#responsible-gambling > div.form__body > div:nth-child(2) > div.col-md-4.self-exclude.timeout-sb > span > span.selection > span > span.select2-selection__arrow";
            ...
            public const string SelfExcludeArrowAttr = "#responsible-gambling > div.form__body > div:nth-child(3) > div.col-md-4.self-exclude.selfexclude-sb > span > span.selection > span > span.select2-selection__arrow";
            ...
            public const string TimeOutSelfExcludeSaveBtnAttr = "#responsible-gambling > div.form__body > div:nth-child(4) > div.col-lg-12.top__space > input";

            public const string TimeOutSelfExcludeModalOkBtnAttr = "#exclude-ok";

            public const string ResponsibleGamingCompleteTitleAttr = "#responsible-gambling-div > div > h2";
        }
    }
}
