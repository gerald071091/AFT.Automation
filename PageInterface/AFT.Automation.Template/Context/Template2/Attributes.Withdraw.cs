namespace AFT.Automation.Template.Context.Template2
{
    ...
    {
        /// <summary>
        /// Template 2 Withdraw page attributes
        /// </summary>
        protected static class WithdrawAttribtue
        {
            ...
            public const string WithdrawBtnAttr = "#Withdrawal > div:nth-child(2) > div.form > form > div:nth-child(6) > div.form-group.margined-right > div:nth-child(1) > input";
        }
    }
}
